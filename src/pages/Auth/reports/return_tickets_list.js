...
const ReturnTicketList = () => {
  ...
  const getReturnTicketList = () =>{
    axios
    .post(requests.getExpiredTicketList, { tktBatchNumber: 436567567867 })
    .then((res) => {
...
//teamparmarit@gmail.com  Pparmar@2023
  ...
  const actionButton = (params) => {
    history.push(
        `/report/return-ticket-details/${params.data.tktBatchNumber}`
      );
...
//    }
  ...
  return (
    <>
    <Titlebanner title="Return Tickets"/>
